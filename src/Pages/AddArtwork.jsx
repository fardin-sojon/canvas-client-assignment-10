...
import { FaImage, FaPalette, FaLayerGroup, FaPenNib, FaEye, FaEyeSlash, FaGlobe, FaLock, FaArrowLeft } from "react-icons/fa";
      ...
      >
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 py-8 px-8 text-center relative overflow-hidden">
          ...
          <p className="relative text-purple-100 mt-2 text-lg">
            Add your masterpiece to the Canvas Connect gallery.
          </p>
        </div>
          ...
          <form onSubmit={handleAddArtwork} className="space-y-8">
               ...
               <div className="form-control">
                 ...
                 <div className="flex gap-4">
                    <label className="cursor-pointer label gap-2 border border-gray-200 rounded-lg px-4 py-2 hover:bg-purple-50 transition-colors">
                      <input type="radio" name="visibility" value="Public" className="radio radio-primary radio-sm" defaultChecked />
                      <span className="label-text font-medium flex items-center gap-2"><FaGlobe className="text-blue-500"/> Public</span>
                    </label>
                    <label className="cursor-pointer label gap-2 border border-gray-200 rounded-lg px-4 py-2 hover:bg-purple-50 transition-colors">
                      <input type="radio" name="visibility" value="Private" className="radio radio-primary radio-sm" />
            ...
            >
              {loading ? (
                ...
                <>
                  <FaPenNib className="mr-2" /> Add Artwork
                </>
              )}
            </motion.button>
          </form>
